...
jQuery(document).ready(function () {
    ...
    theme_conrols.on('click', '.customizer-repeater-new-field', function () {
        ...
        if(ParentId == 'customize-control-spawp_option-slider_content' && jQuery('#customize-control-spawp_option-pricing_content').length==0 ){   
            var numItems = jQuery("#customize-control-spawp_option-slider_content .customizer-repeater-general-control-repeater-container").length 
            if(numItems >= 2){ 
              jQuery( "#customize-control-spawp_option-spawp_slider_upgrade .spawp-upgrade-premium-message" ).show();
              return false;   
            }
        }

        if(ParentId == 'customize-control-spawp_option-feature_content' && jQuery('#customize-control-spawp_option-pricing_content').length==0 ){
            var numItems = jQuery("#customize-control-spawp_option-feature_content .customizer-repeater-general-control-repeater-container").length 
            if(numItems >= 3){
              jQuery( "#customize-control-spawp_option-spawp_feature_upgrade .spawp-upgrade-premium-message" ).show();
              return false;   
            }
        }

        if(ParentId == 'customize-control-spawp_option-testimonial_content' && jQuery('#customize-control-spawp_option-pricing_content').length==0 ){
            var numItems = jQuery("#customize-control-spawp_option-testimonial_content .customizer-repeater-general-control-repeater-container").length 
            if(numItems >= 1){ 
              jQuery( "#customize-control-spawp_option-spawp_testimonial_upgrade .spawp-upgrade-premium-message" ).show();
              return false;   
            }
        }

        if(ParentId == 'customize-control-spawp_option-team_content' && jQuery('#customize-control-spawp_option-pricing_content').length==0 ){
            var numItems = jQuery("#customize-control-spawp_option-team_content .customizer-repeater-general-control-repeater-container").length 
            if(numItems >= 2){ 
               jQuery( "#customize-control-spawp_option-spawp_team_upgrade .spawp-upgrade-premium-message" ).show();
              return false;   
            }
        }
