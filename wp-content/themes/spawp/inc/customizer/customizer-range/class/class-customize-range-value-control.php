<?php
if ( ! class_exists( 'SPAWP_Customize_Base_Control' ) ) {
	return;
}

define( 'SPAWP_RANGE_VERSION', '1.0.0' );

class SPAWP_Customize_Range_Value_Control extends SPAWP_Customize_Base_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'customizer-range-value-control', get_template_directory_uri() . '/inc/customizer/customizer-range/js/customizer-range-value-control.js', array( 'jquery', 'customize-base' ), SPAWP_RANGE_VERSION, true );
		wp_enqueue_style( 'customizer-range-value-control', get_template_directory_uri() . '/inc/customizer/customizer-range/css/customizer-range-value-control.css', array(), SPAWP_RANGE_VERSION );
	}
 ...
 */
function spawp_sanitize_range_value( $input ) {
	if ( is_json( $input ) ) {
